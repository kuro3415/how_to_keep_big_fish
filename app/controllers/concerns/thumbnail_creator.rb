class ThumbnailCreator
  ...
  USER_NAME_FONT_SIZE = 30
  FISH_NAME_FONT_SIZE = 60
  USER_NAME_TEXT_POSITION = '0, 250'.freeze
  FISH_NAME_TEXT_POSITION = '0,-220'.freeze
  INDENTION_COUNT = 20
  ROW_LIMIT = 2
  ...
  class << self
    def build(user_name, fish_name, post_image)
      ...
      image_with_name = image.combine_options do |config|
        ...
        config.draw "text #{USER_NAME_TEXT_POSITION} 'by #{user_name}'"
      end
